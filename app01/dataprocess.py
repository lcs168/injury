...
with mp_hands.Hands(
        ...
        min_detection_confidence=0.7,  # 置信度高于0.65，输出手部模型
    ...
    while cap.isOpened():
        ...
        in_dim = in_dim.unsqueeze(dim=0) # 增加两维
        ...
        # 对每个动作设置单独的置信度阈值
        cfd = {'还原': 0.9, '旋转': 0.9,  '截图': 0.9, '放大': 0.9}
